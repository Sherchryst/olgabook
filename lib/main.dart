...
void main() {
  final store = Store<CategoryState>(stateReducer,
      initialState: CategoryState([
        Category(0, Icons.person, Colors.green[300], "Personnel", [
          Task(0, "Dire je t'aime à Sherchryst", false),
        ]),
        Category(1, Icons.content_paste, Colors.orange, "Travail", []),
        Category(2, Icons.warning, Colors.red, "Important", [])
      ]));
